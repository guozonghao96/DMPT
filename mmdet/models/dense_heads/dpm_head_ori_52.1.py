...
#                                                                                       *featmap_sizes[2]), dim=0) # num_gt, num_part, h, w
            ...
            weighted_deform_cost = (deform_cost * part_deform.reshape(1, self.num_semantic_points, 1, 1, 4)).sum(-1)
            ...
            all_deformable_costs.append(deform_cost * part_deform.reshape(1, 
                                                                          self.num_semantic_points, 
                                                                          1, 1, 4) * part_based_masks.unsqueeze(-1))
            all_weighted_deform_costs.append(deform_cost * part_deform.reshape(1, 
                                                                          self.num_semantic_points, 
                                                                          1, 1, 4))
