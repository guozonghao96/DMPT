...
class PointDETRHead(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        if class_weight is not None and (self.__class__ is PointDETRHead):
        ...
        if transformer_refine is None:
            self.transformer_refine = None
        else:
            self.transformer_refine = build_transformer(transformer_refine)
            
        if transformer_mask is None:
            self.transformer_mask = None
        else:
            self.transformer_mask = build_transformer_layer_sequence(transformer_mask)
