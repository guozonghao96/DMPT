...
class FCNMaskHead_(BaseModule):
    ...
    def __init__(self,
        ...
        super(FCNMaskHead_, self).__init__(init_cfg)
    ...
    def init_weights(self):
        super(FCNMaskHead_, self).init_weights()
    ...
    def loss(self, mask_pred, mask_targets, labels):
        ...
        loss["loss_mask"] = loss_mask * self.loss_weight_mask_start
        return loss
