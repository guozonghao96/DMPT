...
class MAEMaskHeadPointSup(nn.Module):
    def __init__(self,
                 roi_feat_size=14,
                 num_classes=80,
        ...
        self.loss_weight_mask_start = loss_weight_mask_start
    ...
    # def loss(self, mask_pred, mask_targets, labels, weight=None):
    #     """
    #     Example:
    ...
    #                                        torch.zeros_like(labels), ignore_weight=weight)
    #         else:
    #             loss_mask = self.loss_mask(mask_pred, mask_targets, labels, ignore_weight=weight)
    ...
    def loss(self, mask_pred, mask_targets, labels):
        ...
        loss["loss_mask"] = loss_mask * self.loss_mask.loss_weight #* self.loss_weight_mask_start
#         loss["loss_mask"] = loss_mask * 0 # self.loss_weight_mask_start
        return loss
