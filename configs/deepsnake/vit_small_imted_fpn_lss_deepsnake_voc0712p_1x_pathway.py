...
model = dict(
    ...
    decoder_head=dict(
        type='PanopticDeepLabDecoderPathway',
        ...
        instance_head=dict(
            ...
            decoder_channels=128,
            head_channels=(32, 32, 64, 128, 256, 512, 512),
            num_classes=(2, 2, 2, 2, 2, 2, 2),
            class_key=["offset1", "offset2", "offset3", "offset4", "offset5",
                      "offset6", "offset7"]),
        loss_offset=dict(type='L1Loss', loss_weight=0.01),
    ),
    snake_head=None,
    # snake_head=dict(
    #     type='DeepSnakeHead',
