...
model = dict(
    ...
    lss_head=dict(
        ...
        point_head=dict(
            ...
            cls_mlp_depth=3,
            reg_mlp_depth=3,
            loss_point=dict(type='L1Loss', loss_weight=0.0),
    ...
    train_cfg=dict(
        lss=dict(
            ...
            pooling=dict(
                ...
                discard=0.9,
                multiple=False,
                scale_method='average', # "single" or "auto" or "average"
                scale=12, # when "scale_method" is "auto" or "single" this item is available
            )),
        rpn=dict(
            assigner=dict(
                type='MaxIoUAssigner',
    ...
    test_cfg=dict(
        lss=dict(
            cam_thr=0.2, 
            area_ratio=0.5,
            box_method='min_max', # min-max, shift, expand
