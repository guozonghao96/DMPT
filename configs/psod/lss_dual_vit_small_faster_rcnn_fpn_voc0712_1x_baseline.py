'''
This is a baseline for LSS
This framework use the average attention maps over the whole layers.
It has no mil_head.
It is different from previous baselines: 
    loss weight of point classification is 2
    loss weight of point regression is 5
'''
...
#                 type='roi',
    ...
    test_cfg=dict(
        lss=dict(
            cam_thr=0.2, 
            area_ratio=0.5,
            box_method='min_max', # min_max, shift, expand
