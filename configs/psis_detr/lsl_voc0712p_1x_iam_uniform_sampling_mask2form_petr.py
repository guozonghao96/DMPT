...
#         with_gt_points=False,
        ...
        num_outs=3,
        transformer=dict(
            type='PointDeformableDetrTransformer',
            num_feature_levels=4,
            num_keypoints=1,
            # type='PointPartDeformableDetrTransformer',
            # encoder=None,
            encoder=dict(
