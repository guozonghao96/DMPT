...
#     scale_head=None,
    scale_head=dict(
        ...
        loss_mil=dict(
            ...
            reduction='mean',
            loss_weight=0.25),
        loss_loc=dict(type='SmoothL1Loss', beta=0.11, loss_weight=0.1),
        loss_reg=dict(type='GIoULoss', loss_weight=0.1),
        loss_shift_reg=dict(type='GIoULoss', loss_weight=0.1),
    ),
    scale_head1=None,
#     scale_head1=dict(
#         type='MILMeanShiftHead',
...
#             loss_weight=0.25),
#         loss_reg=dict(type='GIoULoss', loss_weight=0.1),
#         loss_shift_reg=dict(type='GIoULoss', loss_weight=0.5),
#     ),
    decoder_head=None,
    offset_head=None,
    snake_head=None,
